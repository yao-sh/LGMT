...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input-path',
        type=str,
        default='model_checkpoints/gpt2-xl-prefix/checkpoint_1000',
        help='model-name')
    parser.add_argument('--output-path',
                        type=str,
                        default='model_checkpoints/gpt2-xl-prefix-result',
                        help='model-name')
    parser.add_argument('--n-stages', type=int, default=2, help='')
    parser.add_argument('--n-layer-per-stage', type=int, default=14, help='')
