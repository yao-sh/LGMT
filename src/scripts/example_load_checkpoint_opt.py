...
def load_decentralized_checkpoint(model,
    ...
    for i in range(n_stages):
        ...
        if i == 0:
            ...
            model.model.decoder.embed_tokens.weight.data[:] = _tmp[
                'embed_tokens.weight']
            model.model.decoder.embed_positions.weight.data[:] = _tmp[
            ...
            for j in range(n_layer_per_stage):
                ...
                model.model.decoder.layers[i * n_layer_per_stage +
            ...
            model.model.decoder.final_layer_norm.weight.data[:] = _tmp[
                'final_layer_norm.weight']
            model.model.decoder.final_layer_norm.bias.data[:] = _tmp[
...
if __name__ == '__main__':
    ...
    load_decentralized_checkpoint(
        model,
        'model_checkpoints/opt-baseline/checkpoint_2000',
        n_stages=2,
