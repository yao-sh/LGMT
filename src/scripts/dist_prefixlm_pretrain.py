...
def train_loop(args, pipe, device, train_data_loader, test_data_loader):
    ...
    prefix_masks = torch.zeros([args.batch_size, args.seq_length],
    ...
    if get_pipeline_parallel_rank() == 0 and dp_rank == 0:
        ...
        for data in train_data_loader:
            ...
            prefix_masks_global = data['prefix_masks'].to(
            ...
            current_iter_time = pipe.sgd_iter(
                input_ids, None, aux_input_data={'prefix_masks': prefix_masks})
        ...
        while True:
            ...
            current_iter_time = pipe.sgd_iter(
                ...
                aux_input_data={'prefix_masks': prefix_masks})  # lm loss func
