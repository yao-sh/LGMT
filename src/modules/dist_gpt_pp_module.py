...
class GPTStageBase(nn.Module):
    ...
    def __init__(self, args, config):
        ...
        self._layer_end = min(self._layer_begin + args.num_layers,
                              args.max_layers)
        ...
        if hasattr(args, 'model_type'):
            if args.model_type == "gpt2":
                ...
                from .hf_gptneo_modules import (GPTBlock, GPTEmbeddings,
                                                GPTLMHead)
            elif args.model_type == "gptneox":
                from .hf_gptneox_modules import (GPTBlock, GPTEmbeddings,
                                                 GPTLMHead)
