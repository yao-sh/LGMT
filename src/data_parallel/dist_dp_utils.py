...
def get_dp_module(args, device, module, optimizer):
    ...
    if args.dp_mode == 'allreduce':
        return AllReduceDP(
            args, device, module, optimizer,
            flatten=False)  # flatten seems to be not compatible with fp16
        ...
        return ShardedPSDPCompressed(args,
                                     device,
                                     module,
                                     optimizer,
                                     flatten=False)
        ...
        return AFreezeCompressDP(args,
                                 device,
                                 module,
                                 optimizer,
                                 flatten=False)
    elif args.dp_mode == 'afreeze_compressed_2':
        return AFreezeCompress2DP(args,
                                  device,
                                  module,
                                  optimizer,
                                  flatten=False)
        ...
        return SlotSGDGlooBenchDP(args,
                                  device,
                                  module,
                                  optimizer,
                                  flatten=True)
