        ...
        if self.flatten:
            ...
            with torch.cuda.stream(self.dp_comm_stream), cupy_dp_stream:
                ...
                if global_steps % global_sync_steps == 0:
                    ...
                    original_bits += para.numel(
                    ) * 16  #torch.finfo(para.dtype).bits
                    ...
                    if name not in dp_state_dict:
                        ...
                        for i in range(self.dp_group_size):
                            ...
                            if n_potisive != 0:
                                comm_mask.view(-1)[comm_mask.view(-1).cumsum(
                                    -1) > n_potisive] = False
                    ...
                    for i in range(self.dp_group_size):
                        ...
                        worker_error.data[i * chunk_size:(i + 1) * chunk_size][
                            comm_mask_list[
                                i]] = comm_data_list[i] - _data_compressed
