        ...
        if self.flatten:
            ...
            with torch.cuda.stream(self.dp_comm_stream), cupy_dp_stream:
                ...
                for i in range(self.dp_group_size):
                    ...
                    dp_state_dict[name]['comm_mask_list'][i] = tmp.topk(
                        k=dp_state_dict[name]["comm_data_list"]
                        [i].numel()).indices  # mask to indices
                ...
                for i in range(self.dp_group_size):
                    ...
                    global_para.data[i * chunk_size:(i + 1) * chunk_size][
                        comm_mask_list[i]] += _data * global_lr
