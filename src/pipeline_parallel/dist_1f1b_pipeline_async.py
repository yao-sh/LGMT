...
# >>>>>>> main
        ...
        if use_dp:
            ...
            self.dp_optim = get_dp_module(args, device, self.model,
                                          self.optimizer)
        else:
            self.optimizer = optim.SGD(self.model.parameters(), lr=args.lr)
    ...
    def _compute_micro_batch_size(self):
        ...
        print("Current micro-batch send/recv size: {} MB".format(
    ...
    def profiling_optimizer_step(self):
        ...
        if not self.use_dp:
            ...
            self.profiling_log.extend(
                self.dp_optim.profiling_data_parallel(self.init_time_stamp,
                                                      self.init_event))
