...
try:
    ...
    print(
        "Warning: failed to load package 'sqlitedict', please install before using it."
    )
...
class BaseLM(LM):
    ...
    def _loglikelihood_tokens(self, requests, disable_tqdm=False):
        ...
        for chunk in utils.chunks(
                tqdm(reord.get_reordered(), disable=disable_tqdm),
                self.batch_size):
            inps = []
            cont_toks_list = []
            inplens = []
            ...
            for _, context_enc, continuation_enc in chunk:
                ...
                inp = torch.cat(
                    [
                        inp,  # [seq]
                        torch.zeros(
                            padding_length - inplen, dtype=torch.long).to(
